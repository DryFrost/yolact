...
ara_plant_dataset = dataset_base.copy({
  'name': 'Arabidopsis Instance Segmentation',
  'train_info': '/content/dataset/dataset/test_coco.json',
...
resnet50_backbone = resnet101_backbone.copy({
    'name': 'ResNet50',
    'path': 'yolact_plus_resnet50_plants_2403_24033_interrupt.pth',
    'type': ResNetBackbone,
    'args': ([3, 4, 6, 3],),
    'transform': resnet_transform,
})
...
yolact_resnet50_plants_config = yolact_resnet50_config.copy({
    'name': 'yolact_plus_resnet50_plants',
    # Dataset stuff
    'dataset': ara_plant_dataset,
